...
const pageTitle = "Forgot Password - Kandil Internal Portal";
const pageDescription = "Reset your password for Kandil Internal Portal. Enter your email to receive password reset instructions.";
